 ...
 *
 * @file
 * @brief       Configuration of CPU peripherals for Thermokon MPRS06-LCD-A
 *
...
static const adc_chan_conf_t adc_channel_config[] = {
    ...
    {
        .dev = 0,
        .input = adcPosSelAPORT4XCH29,  /* use PB13 as input */
        .reference = adcRef5V,          /* internal 5V ref voltage */
        .acq_time = adcAcqTime8         /* acquisition time -> 8 clock cycles */
    }
};
...
static const spi_dev_t spi_config[] = {
    {
        USART1,                             /* device */
        GPIO_PIN(PD, 14),                   /* MOSI pin */
        GPIO_UNDEF,                         /* MISO pin */
        GPIO_PIN(PD, 13),                   /* CLK pin */
        //USART_ROUTELOC0_RXLOC_LOC11 |     /* not defined */
            USART_ROUTELOC0_TXLOC_LOC22 |
            USART_ROUTELOC0_CLKLOC_LOC19,   /* AF location */
